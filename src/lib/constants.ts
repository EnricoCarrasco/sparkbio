...
export const THEME_PRESETS_PREMIUM = [
  {
    ...
    title_font: "Fraunces",
    title_color: "#1A1A1A",
    title_size: "large" as const,
    hide_bio: false,
    button_font_size: "medium" as const,
    wallpaper_style: "fill" as const,
  ...
  },
  {
    ...
    wallpaper_style: "gradient" as const,
    bg_gradient_from: "#0A0A0B",
    bg_gradient_to: "#101012",
  ...
  },
  {
    ...
    wallpaper_style: "gradient" as const,
    bg_gradient_from: "#0E0812",
    bg_gradient_to: "#29113F",
    bg_gradient_direction: "to bottom right",
    wallpaper_animate: true,
    wallpaper_noise: true,
  },
  {
    name: "Rose Gold",
